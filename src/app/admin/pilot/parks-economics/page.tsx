...
export const metadata = { title: "Parks Pilot Economics · FALCO Admin", robots: "noindex, nofollow" }

// ============================================================================
// Print-ready one-pager for the Parks Auction & Realty pilot meeting.
// Designed to be opened, printed (Cmd/Ctrl+P → Save as PDF), and handed to
// Dale Nichols at the Apr 23 meeting. Single page, 8.5x11.
// ============================================================================
...
export default async function ParksEconomicsPage() {
      ...
      <article className="mx-auto max-w-3xl px-8 py-10">
          ...
          <table className="w-full border border-neutral-300 text-[13px]">
            <tbody>
              <tr className="border-b border-neutral-200">
                ...
                <td className="px-4 py-3 text-right tabular-nums text-red-600 font-semibold w-[140px]">$0</td>
                <td className="px-4 py-3 text-[11px] text-neutral-500 w-[260px]">Bank takes property for loan balance.</td>
              </tr>
              <tr className="border-b border-neutral-200">
                ...
                <td className="px-4 py-3 text-[11px] text-neutral-500">70% rule formula sweetened to close.</td>
              </tr>
              <tr className="bg-emerald-50">
                ...
                <td className="px-4 py-3 text-[11px] text-neutral-700">Open competitive bidding, 84% of retail.</td>
              </tr>
            </tbody>
          </table>
        ...
        <footer className="mt-8 pt-4 border-t border-neutral-300 text-[11px] text-neutral-500">
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div>
              FALCO LLC · Tennessee · falco@falco.llc · falco.llc
            </div>
            <div>
              Patrick Armour, Founder
            </div>
          </div>
          <p className="mt-2 text-[10px] leading-[1.5]">
            All economics derived from the standard 8% buyer's premium model with
            5% to Parks and 3% to FALCO of winning bid. Sources for distress and
            pricing assumptions: <strong>falco.llc/manifesto#sources</strong>.
          </p>
        </footer>
      </article>
    </main>
...
function Bar({
  ...
  return (
    <div className={`relative rounded border border-neutral-200 bg-white p-3 ${full ? "" : ""}`}>
...
function Row({ k, v }: { k: string; v: string }) {
  return (
    <tr className="border-b border-neutral-200 last:border-b-0">
      <td className="px-4 py-2 text-[11px] uppercase tracking-[0.14em] text-neutral-500 font-semibold w-[180px]">
        {k}
      </td>
