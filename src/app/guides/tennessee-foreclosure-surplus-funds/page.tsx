      ...
      <GuideShell
        ...
        title={
          <>
            ...
            <span className="text-emerald-400">surplus funds</span>: is money
            owed to you?
          </>
        }
        standfirst={
      ...
      >
        <GuideSection title="What surplus funds are">
          <p>
            ...
            is called <strong className="text-white/90">surplus funds</strong>{" "}
          ...
          <GuideNote label="The order the money is paid out">
            <ol className="list-decimal ml-4 space-y-1">
              ...
              <li>
                <strong className="text-white/85">The former owner</strong> gets
                whatever is left
              </li>
            </ol>
          </GuideNote>
        ...
        <GuideSection id="how-to-claim" title="How the money reaches you">
          <p>
            ...
            <strong className="text-white/85">trustee holds the surplus</strong>.
            ...
            <strong className="text-white/85">Chancery Court</strong> and let a
            judge sort it out. In Tennessee that court office is the{" "}
            <strong className="text-white/85">Clerk &amp; Master</strong> of the
          ...
          <GuideKey>
            ...
            <a href="/foreclosure" className="text-emerald-300 hover:text-emerald-200 underline underline-offset-4">
              county page
            </a>{" "}
          ...
          <GuideNote label="A trap to avoid">
            ...
            for delinquent <strong className="text-white/85">property-tax</strong>{" "}
        ...
        <GuideSection id="unclaimed" title="If nobody claims it: the state holds it for you">
          <p>
            ...
            then sent to the{" "}
            <strong className="text-white/85">Tennessee Department of Treasury,
          ...
          <GuideKey>
            ...
            free at{" "}
            <a href="https://claimittn.gov" target="_blank" rel="noopener noreferrer nofollow" className="text-emerald-300 hover:text-emerald-200 underline underline-offset-4">
              ClaimItTN.gov
            </a>
        ...
        <GuideSection id="recovery-companies" title="Watch out for 'surplus recovery' companies">
          ...
          <GuideNote label="1. Once the money is with the state, the fee is capped">
            ...
            <strong className="text-white/85">10 percent</strong> (or $50,
